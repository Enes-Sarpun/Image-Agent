...
| 🌐 Web Arayüzü | FastAPI + vanilla HTML/CSS/JS: `uvicorn api:app` |
...
├── pyproject.toml
│
├── api.py                       # FastAPI — HTTP server & static file serving
│
├── frontend/                    # Web arayüzü (vanilla HTML/CSS/JS)
│   ├── index.html
│   ├── style.css
│   └── script.js
│
├── src/                         # Backend — analiz motoru
...
│
└── data/
    └── cache/                   # SQLite cache (otomatik oluşur)
        └── cache.db
```
...
Tarayıcıda `http://127.0.0.1:8000` açılır. Görseli sürükle-bırak ile yükle, sonucu anında gör.
